...
export function setProperty(dom, name, value, oldValue, namespace) {
	...
	// Benchmark for comparison: https://esbench.com/bench/574c954bdb965b9a00965ac6
		...
		// dom._listeners[name + useCapture] = value; // MODDED
		dom._addToListeners(name + useCapture, value) // MODDED
...
function createEventProxy(useCapture) {
	...
	return function (e) {
		...
		this._callListener(eventName + useCapture, options.event ? options.event(e) : e);
	}
}
